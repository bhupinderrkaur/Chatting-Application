...
public class Server implements ActionListener {
    ...
    JPanel p1; //globally declare div type thing in html
    JTextField t1;
    JButton b1;
   static JPanel a1;
  ...
  static Box vertical = Box.createVerticalBox();
   ...
   Server(){ //constructor 
       ...
       ImageIcon i4 =new ImageIcon("C:\\Users\\hp\\Documents\\NetBeansProjects\\Chatting Application\\src\\chatting\\application\\icons\\harry.jpg");
   ...
   public static void main(String[] args){
       new Server().f1.setVisible(true); //object call
      
       try{
           
           String msginput ="";
       
           skt=new ServerSocket(6001); //which port to connect to
           while(true){
           s=skt.accept(); //server class obj which accepts data from client
           din=new DataInputStream(s.getInputStream()); //from client
           dout=new DataOutputStream(s.getOutputStream()); //to send out
           while(true){
